...
//     subtitle: "Our Freshora team will pick up your clother within 1 hour",
//   },
//   {
//     status: "pickedUp",
    ...
    <div className="max-w-2xl mx-auto p-4 space-y-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Enter your order number to track the status of your laundry service
          </CardDescription>
        </CardHeader>
          ...
          <CardHeader>
            <div className="flex items-center justify-between">
              <div>
                ...
                <CardDescription>
                  Placed on {formatDate(orderStatus.createdAt)}
                </CardDescription>
              </div>
          ...
          <CardContent className="space-y-6">
                ...
                <div className="text-sm space-y-1 bg-blue-50 p-3 rounded-lg">
                  <p>
                    ...
                    {orderStatus.pickupDate
                      ? formatDate(orderStatus.pickupDate)
                      : "Not scheduled"}
                  </p>
                  <p>
                    <strong>Address:</strong>{" "}
                    {orderStatus.customer?.address || "Not provided"}
                  </p>
                  <p>
                    <strong>City:</strong>{" "}
                    {orderStatus.customer?.city || "Not provided"}
                  </p>
                  <p>
                ...
                <div className="text-sm space-y-1 bg-green-50 p-3 rounded-lg">
                  <p>
                    ...
                    {orderStatus.deliveryDate
                      ? formatDate(orderStatus.deliveryDate)
                      : "Not scheduled"}
                  </p>
                  <p>
                    <strong>Address:</strong>{" "}
            ...
            <div className="space-y-3">
              ...
              <div className="text-sm space-y-1 bg-gray-50 p-3 rounded-lg">
                <p>
                  <strong>Name:</strong>{" "}
                  {orderStatus.customer?.name || "Not provided"}
                </p>
                <p>
                  <strong>Email:</strong>{" "}
                  {orderStatus.customer?.email || "Not provided"}
                </p>
                <p>
                  <strong>Phone:</strong>{" "}
                  {orderStatus.customer?.phone || "Not provided"}
                </p>
                <p>
                  <strong>Address:</strong>{" "}
                  {orderStatus.customer?.address || "Not provided"}
