...
const slides = [
  {
    ...
    description:
      "We are professionals in the laundry and dry cleaning business, staying up to date on the latest technologies, cleaning methods, and solutions for stains or delicate fabrics.",
  ...
  },
  {
    ...
    description:
      "We follow the highest standards of integrity, regulations, and environmental safety. We are passionate about changing the way you think about laundry!",
  ...
  },
  {
    ...
    description:
      "Our ironing service makes your garments crisp, wrinkle-free, and ready to wear. Precision and care in every detail.",
  ...
  },
  {
    ...
    description:
      "We deliver services that exceed expectations. If you're not completely satisfied, we’ll make it right.",
